...
export default function ProductCart({ product }: ProductCartProps) {
  ...
  return (
    <div className="bg-white rounded-3xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
      ...
      {/* Product Info */}
      <div className="p-5">
        <h3 className="text-plant-dark font-bold text-lg mb-2 line-clamp-1">{product.name}</h3>
        
        <div className="flex items-center justify-between">
          <div>
            <p className="text-2xl font-bold text-plant-green">Rp {(product.price / 1000).toFixed(0)}k</p>
