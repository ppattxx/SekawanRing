    ...
    <div className="min-h-screen bg-[#F8FBF9] pb-20">
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-center">
          <div>
            ...
            <p className="text-green-50 text-sm md:text-base opacity-90 max-w-md">
              Temukan burung Murai Batu bersertifikat dengan kualitas kontes dan trah juara dari seluruh Nusantara.
            </p>
          </div>
          
          {/* Ilustrasi Dekoratif di Header (Opsional) */}
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 -mt-12 relative z-10">
        ...
        <div className="bg-white rounded-2xl shadow-[0_8px_30px_rgba(0,0,0,0.06)] p-2 flex items-center mb-12 border border-gray-100">
          <div className="pl-4">
            <svg className="w-6 h-6 text-plant-green" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {/* SECTION TITLE (Sudah dirapikan posisinya) */}
        <div className="mb-8 flex flex-col md:flex-row md:items-end justify-between gap-4">
          <div>
            <h2 className="text-3xl font-black text-plant-dark">
              Jenis Murai Batu
            </h2>
            <p className="text-gray-500 font-medium mt-1">Pilih kategori untuk melihat stok burung</p>
          </div>
          
          <div className="flex gap-2">
            <span className="bg-plant-green text-white px-4 py-2 rounded-xl text-sm font-bold shadow-sm">Semua</span>
            <span className="bg-white text-gray-500 hover:text-plant-dark px-4 py-2 rounded-xl text-sm font-bold shadow-sm cursor-pointer transition-colors">Terpopuler</span>
          </div>
        </div>
              ...
              <div className="pt-6 pb-2 px-3 flex-1 flex flex-col">
                ...
                <div className="mt-auto pt-4 border-t border-gray-100 flex items-center justify-between">
                  ...
                  <div className="w-8 h-8 rounded-full bg-plant-light flex items-center justify-center group-hover:bg-plant-green transition-colors">
                     <span className="text-plant-green group-hover:text-white text-xs font-bold transition-colors">+</span>
                  </div>
                </div>
              </div>
            </Link>
        ...
        <div className="bg-plant-dark rounded-[2.5rem] p-8 md:p-12 shadow-2xl mt-16 relative overflow-hidden">
          ...
          <div className="relative z-10 text-center max-w-3xl mx-auto">
            ...
            <p className="text-gray-400 mb-10 text-sm md:text-base">Berkomitmen penuh memberikan burung kualitas terbaik untuk para penghobi dan petarung sejati.</p>
            
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="flex flex-col items-center">
                <div className="w-16 h-16 bg-plant-green rounded-2xl flex items-center justify-center text-3xl mb-4 shadow-lg transform rotate-3">🏆</div>
                <h4 className="font-bold text-white mb-2">Trah Juara</h4>
                <p className="text-sm text-gray-400 text-center">Indukan pilihan dengan rekam jejak juara nasional.</p>
              </div>
              <div className="flex flex-col items-center">
                <div className="w-16 h-16 bg-plant-light rounded-2xl flex items-center justify-center text-3xl mb-4 shadow-lg transform -rotate-3">📜</div>
                <h4 className="font-bold text-white mb-2">Bersertifikat Resmi</h4>
                <p className="text-sm text-gray-400 text-center">Dilengkapi sertifikat asli ring peternak terdaftar.</p>
              </div>
              <div className="flex flex-col items-center">
                <div className="w-16 h-16 bg-white rounded-2xl flex items-center justify-center text-3xl mb-4 shadow-lg transform rotate-3">💚</div>
                <h4 className="font-bold text-white mb-2">Garansi Kesehatan</h4>
                <p className="text-sm text-gray-400 text-center">Jaminan burung rawatan sehat tanpa cacat fisik.</p>
              </div>
            </div>
          </div>
        </div>
